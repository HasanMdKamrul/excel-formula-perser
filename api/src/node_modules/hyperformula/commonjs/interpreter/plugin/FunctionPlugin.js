    ...
    this.runFunction = (args, state, metadata, fn) => {
      ...
      if (!metadata.vectorizationForbidden && state.arraysFlag) {
        for (let i = 0; i < argValues.length; i++) {
          ...
          if (val instanceof _SimpleRangeValue.SimpleRangeValue && argumentDefinitions[i].argumentType !== FunctionArgumentType.RANGE && argumentDefinitions[i].argumentType !== FunctionArgumentType.ANY) {
          ...
          for (let i = 0; i < argumentDefinitions.length; i++) {
            ...
            if (arg === undefined) {
              ...
              if (coercedArg !== undefined) {
                if (coercedArg instanceof _Cell.CellError && argumentDefinitions[i].argumentType !== FunctionArgumentType.SCALAR) {
